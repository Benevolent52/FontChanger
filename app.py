...
class CustomMessageBox(QMainWindow):
    def __init__(self, title, message, parent=None):
        ...
        # Кнопка OK
        ok_btn = StyledButton("АХУЕНА")
        ok_btn.setStyleSheet("width: 80px; height: 25px; font-size: 20px; background-color: #BA55D3")
...
class DiagonalStripe(QWidget):
    ...
    def paintEvent(self, event):
        ...
        gradient.setColorAt(0, QColor("#8A2BE2"))
        gradient.setColorAt(1, QColor("#7366BD"))
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Очко ебаное_228")
    ...
    def setup_ui(self):
        self.central_widget = DiagonalStripe(image_path='./theme1.jpg')
        ...
        # Buttons
        self.select_path_btn = StyledButton("Путь к CS2")
        ...
        self.font_btn = StyledButton("Выбрать  файл шрифта (.ttf/.otf)")
    ...
    def select_steam_path(self):
        ...
        if path:
            if self.validate_csgo_path(path):
                ...
                self.show_message("Ошибка", "В папке нет CS2")
